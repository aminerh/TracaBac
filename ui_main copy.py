...
"")
        ...
        self.logo_login.setStyleSheet(u"background :url(:/images/images/images/login.png) no-repeat center  ;\n"
"background-size : 300px;")
        ...
        self.home_header.setMaximumSize(QSize(16777215, 60))
        ...
        self.searchValue = QLineEdit(self.home_header)
        self.searchValue.setObjectName(u"searchValue")
        self.searchValue.setMinimumSize(QSize(0, 30))
        self.searchValue.setMaximumSize(QSize(400, 16777215))
        self.searchValue.setStyleSheet(u"background-color: rgb(33, 37, 43);")

        self.horizontalLayout_6.addWidget(self.searchValue)

        self.searchTSX = QPushButton(self.home_header)
        self.searchTSX.setObjectName(u"searchTSX")
        self.searchTSX.setMinimumSize(QSize(150, 30))
        self.searchTSX.setStyleSheet(u"background-color: rgb(52, 59, 72);")
        icon5 = QIcon()
        icon5.addFile(u":/icons/images/icons/cil-magnifying-glass.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.searchTSX.setIcon(icon5)
        ...
        self.horizontalLayout_6.addWidget(self.cptFilter)
        ...
        self.refresh.setStyleSheet("""
                ...
                QPushButton:enabled {
                        background-color: rgb(52, 152, 219); /* Enabled color */
                }
                QPushButton:disabled {
                        background-color: rgb(149, 165, 166); /* Disabled color */
                        color: rgb(200, 200, 200); /* Faded text color for disabled state */
                }
                """)
        icon6 = QIcon()
        ...
        self.verticalLayout_5.addWidget(self.refresh, 0, Qt.AlignmentFlag.AlignRight)

        self.RefreshTimer = QSlider(self.home_header)
        self.RefreshTimer.setObjectName(u"RefreshTimer")
        self.RefreshTimer.setMinimumSize(QSize(150, 0))
        self.RefreshTimer.setMaximumSize(QSize(150, 10))
        self.RefreshTimer.setOrientation(Qt.Orientation.Horizontal)

        self.verticalLayout_5.addWidget(self.RefreshTimer, 0, Qt.AlignmentFlag.AlignRight)
        ...
        self.TracaBac = QTableWidget(self.home)
        self.TracaBac.setObjectName(u"TracaBac")
        self.TracaBac.setMaximumSize(QSize(16777215, 16777215))

        self.horizontalLayout_8.addWidget(self.TracaBac)
...
" }")
        ...
        self.gridLayout_2.addWidget(self.scrollArea, 0, 5, 4, 1)
        ...
        self.gridLayout_2.addWidget(self.verticalSlider, 0, 2, 4, 1)
...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
        ...
        self.gridLayout_2.addWidget(self.verticalScrollBar, 0, 4, 4, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleRightInfo.setText(QCoreApplication.translate("MainWindow", u"Tracabilit\u00e9 des BAC", None))
        ...
        self.creditsLabel.setText(QCoreApplication.translate("MainWindow", u"By: RHOUNI BELLOUTI Amine", None))
