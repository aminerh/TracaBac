...
"background-size : 300px;")
        ...
        self.verticalLayout_21.addWidget(self.TracaBac)
...
" QScrollBar:horizontal { background: rgb(52, 59, 72); }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.searchValue.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Rechercher un TSX ou Support", None))
